...
def make_T_armrests(args, box_id):
    ...
    right_arm['children'].append({'name': 'arm_horizontal_bar', 'objs': [str(box_id)]})
    box_id += 1
    ...
    out.append(create_axis_aligned_setting(x_min, x_max, y_min, y_max, z_min, z_max))
    right_arm['children'].append({'name': 'arm_near_vertical_bar', 'objs': [str(box_id)]})
    box_id += 1

    left_arm = {'name': 'chair_arm', 'children': []}
    ...
    z_max = args.armDepth
    out.append(create_axis_aligned_setting(x_min, x_max, y_min, y_max, z_min, z_max))
    left_arm['children'].append({'name': 'arm_horizontal_bar', 'objs': [str(box_id)]})
    box_id += 1
    ...
    z_max = args.backDepth + args.armSupportLoc + args.armSupportDepth
    out.append(create_axis_aligned_setting(x_min, x_max, y_min, y_max, z_min, z_max))
    left_arm['children'].append({'name': 'arm_near_vertical_bar', 'objs': [str(box_id)]})
    box_id += 1
